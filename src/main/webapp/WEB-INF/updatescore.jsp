        ...
        <div class="col-md-30">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">分数更新</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <form method="post" class="form-x" action="scoreupdate.htm">
                <!-- text input -->
                <div class="form-group">
                  <label>学号</label>
                   <input type="text" class="form-control" readonly required value="${stuId}" placeholder="专业号" name="stuId">
                </div>
                <div class="form-group">
                  <label>课程号</label>
                   <input type="text" class="form-control" readonly required value="${courseId}" placeholder="课程号" name="courseId">
                </div>
				<div class="form-group">
                  <label>课程名称</label>
                  <input type="text" class="form-control" required  value="${courseName}"  placeholder="课程名称" name="courseName">
                </div>
                <div class="form-group">
                  <label>分数</label>
                  <input type="text" class="form-control" required  value="${stuGrade}" placeholder="分数" name="stuGrade">
                </div>
                
     
				<div class="box-footer">
                <button type="submit" 
				onclick="javascript:window.location.href='couscorelist.htm'" 
