      ...
      <div class="row">
        ...
        <div class="col-md-30">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form method="post" class="form-x" action="specupdata.htm">
                <!-- text input -->
                <div class="form-group">
                  <label>专业号</label>
                   <input type="text" class="form-control" required value="${Spec.specId}" placeholder="专业号" name="specId">
                </div>
				<div class="form-group">
                  <label>专业名称</label>
                  <input type="text" class="form-control" required  value="${Spec.specName}" placeholder="专业名称" name="specName">
                </div>
