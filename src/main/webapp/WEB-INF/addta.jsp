        ...
        <div class="col-md-30">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">增加教师</h3>
                <button type="submit" 
				onclick="javascript:window.location.href='talist.htm'" 
				class="btn  btn-info">返回</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" method="post" class="form-x" action="tainfoadd.htm">
                <!-- text input -->
                <div class="form-group">
                  <label>教工号</label>
                  <input type="text" class="form-control"  required placeholder="教工号" name="taId">
                </div>
                <div class="form-group">
                  <label>姓名</label>
                  <input type="text" class="form-control" required  placeholder="姓名" name="taName">
                </div>
                <!-- select -->
                <div class="form-group">
                  <label>性别</label>
                  <select class="form-control"  placeholder="性别" name="taSex">
                ...
                <div class="form-group">
                  <label>生日</label>
                  <input type="date" class="form-control"  required placeholder="生日" name="taBirth">
                </div>
                <div class="form-group">
                  <label>民族</label>
                  <input type="text" class="form-control" required placeholder="民族" name="taNation">
                </div>
                <div class="form-group">
                  <label>班级</label>
                  <input type="text" class="form-control" required placeholder="班级" name="taClassId">
                </div>
                <div class="form-group">
                  <label>入职时间</label>
                  <input type="date" class="form-control" required placeholder="入职时间" name="taEntranceDate">
                </div>
                <div class="form-group">
                  <label>家庭住址</label>
                  <input type="text" class="form-control" required placeholder="家庭住址" name="taHome">
                </div>
                <div class="form-group">
                  <label>政治面貌</label>
                  <select class="form-control"  placeholder="政治面貌" name="taPolitic">
                ...
                <div class="form-group">
                  <label>身份证号</label>
                  <input type="text" class="form-control" required placeholder="身份证号" name="idNumber">
                </div>
                <div class="form-group">
                  <label>专业</label>
                  <select class="form-control"  placeholder="专业" name="taSpecialty">
                ...
                <div class="form-group">
                  <label>权限</label>
                  <select class="form-control"  placeholder="权限" name="admin">
