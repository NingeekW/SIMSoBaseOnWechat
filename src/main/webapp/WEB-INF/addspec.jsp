            ...
            <div class="box-body">
              <form method="post" class="form-x" action="specinfoadd.htm">
                ...
                <div class="form-group">
                  <label>专业号</label>
                   <input type="text" class="form-control" required  placeholder="专业号" name="specId">
                </div>
				<div class="form-group">
                  <label>专业名称</label>
                  <input type="text" class="form-control" required  placeholder="专业名称" name="specName">
                </div>
