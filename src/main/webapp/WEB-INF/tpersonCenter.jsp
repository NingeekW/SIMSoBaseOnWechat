          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <form role="form" method="post" class="form-x" action="infoupdata.htm">
                ...
                <div class="form-group">
                  <label>性别</label>
                  <select class="form-control"  placeholder="${TAInfo.taSex}" value="${TAInfo.taSex}" name="taSex">
                ...
                <div class="form-group">
                  <label>权限</label>
                  <input type="text" class="form-control" required readonly value="${TAInfo.adminName}" name="admin">
                </div>
