			...
			<section class="sidebar">
				...
				<div class="user-panel">
					...
					<div class="pull-left info">
						<p>${StuInfo.stuName}<p>${TAInfo.taName}</p></p>
					...
					<div class="col-md-30">
						...
						<!-- general form elements disabled -->
							...
							<div class="box-header with-border">
								...
								<button type="submit" 
								onclick="javascript:window.location.href='addta.htm'" 
								class="btn  btn-info">添加教师信息</button>
								<button type="submit" 
								onclick="javascript:window.location.href='talist.htm'" 
								class="btn  btn-info">刷新</button>
							</div>
																<!-- 搜索框 -->
							<form action="TAByName.htm" method="post" id="SelectByName">
								<div class="input-group input-group-lg">
									<input type="text" name="taName" class="form-control"
										placeholder="Search..."> <span class="input-group-btn">
										<button type="submit" name="taName" id="search-btn"
											class="btn btn-flat">
											...
											<div class="row">
												<div class="col-sm-12">
														...
														<thead>
															<tr role="row">
																<th class="sorting_asc" tabindex="0"
																	...
																	aria-sort="ascending"
																	aria-label="Rendering engine: activate to sort column descending">教工号</th>
													...
													<tbody>
														...
														<c:forEach items="${TAInfos}" var="TAInfo">
															<tr role="row" class="odd" id="${TAInfo.taId}">
																<td class="sorting_1">${TAInfo.taId}</td>
																<td>${TAInfo.taName}</td>
																<td>${TAInfo.taSex}</td>
																<td>${TAInfo.taClassId}</td>
																<td>${TAInfo.taSpecialtyName}</td>
																																<td>
																	<div >
																		<button type="submit"
																			onclick="javascript:window.location.href='tainfo.htm?id=${TAInfo.taId}'"
																			class="btn  btn-info">详情</button>
																		<button type="submit"
																			onclick="javascript:window.location.href='tadelete.htm?id=${TAInfo.taId}'"
