            ...
            <div class="box-body">
              <form role="form" method="post" class="form-x" action="infoupdata.htm">
                ...
                <div class="form-group">
                  <label>教工号</label>
                  <input type="text" class="form-control"  readonly placeholder="${AdminInfo.adminId}" value="${AdminInfo.adminId}" name="adminId">
                </div>
                <div class="form-group">
                  <label>姓名</label>
                  <input type="text" class="form-control" required  placeholder="${AdminInfo.adminName}" value="${AdminInfo.adminName}" name="adminName">
                </div>
                <!-- select -->
                <div class="form-group">
                  <label>性别</label>
                  <select class="form-control"  required  placeholder="${AdminInfo.adminSex}" value="${AdminInfo.adminSex}" name="adminSex">
                ...
                <div class="form-group">
                  <label>生日</label>
                  <input type="date" class="form-control"  required placeholder="${AdminInfo.adminBirth}" value="${AdminInfo.adminBirth}" name="adminBirth">
                </div>
                <div class="form-group">
                  <label>民族</label>
                  <input type="text" class="form-control" required placeholder="${AdminInfo.adminNation}" value="${AdminInfo.adminNation}" name="adminNation">
                </div>
                <div class="form-group">
                  <label>入职时间</label>
                  <input type="date" class="form-control" required placeholder="${AdminInfo.adminEntranceDate}" value="${AdminInfo.adminEntranceDate}" name="adminEntranceDate">
                </div>
                <div class="form-group">
                  <label>家庭住址</label>
                  <input type="text" class="form-control" required placeholder="${AdminInfo.adminHome}" value="${AdminInfo.adminHome}" name="adminHome">
                </div>
                <div class="form-group">
                  <label>政治面貌</label>
                  <select class="form-control"   name="adminPolitic">
                    <option value="${AdminInfo.adminPolitic}">${AdminInfo.adminPolitic}</option>
                ...
                <div class="form-group">
                  <label>身份证号</label>
                  <input type="text" class="form-control" required placeholder="${AdminInfo.idNumber}" value="${AdminInfo.idNumber}" name="idNumber">
                </div>
