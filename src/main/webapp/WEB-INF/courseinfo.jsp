            ...
            <div class="box-body">
              <form method="post" class="form-x" action="courseinfoupdata.htm">
                ...
                <div class="form-group">
                  <label>课程号</label>
                   <input type="text" class="form-control" readonly required value="${courseInfo.courseId}" placeholder="专业号" name="courseId">
                </div>
				<div class="form-group">
                  <label>课程名称</label>
                  <input type="text" class="form-control" required  value="${courseInfo.courseName}"  placeholder="专业名称" name="courseName">
                </div>
                <div class="form-group">
                  <label>学分</label>
                  <input type="text" class="form-control" required  value="${courseInfo.credit}" placeholder="专业名称" name="credit">
                </div>
