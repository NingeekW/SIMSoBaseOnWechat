            ...
            <div class="box-body">
              <form role="form" method="post" class="form-x" action="infoupdata.htm">
                ...
                <div class="form-group">
                  <label>学号</label>
                  <input type="text" class="form-control"  readonly required placeholder="${StuInfo.stuId}" value="${StuInfo.stuId}"name="stuId">
                </div>
                <div class="form-group">
                  <label>姓名</label>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control"  placeholder="${StuInfo.stuSex}" value="${StuInfo.stuSex}" name ="stuSex">
                  	<option value="${StuInfo.stuSex}">${StuInfo.stuSex}</option>
                ...
                <div class="form-group">
                  <label>政治面貌</label>
                  <select class="form-control"  placeholder="${StuInfo.stuPolitic}" value="${StuInfo.stuPolitic}" name ="stuPolitic">
                ...
                <div class="form-group">
                  <label>专业</label>
                  <select class="form-control"  placeholder="${StuInfo.stuSpecialty}" value="${StuInfo.stuSpecialty}" name="stuSpecialty">
				...
				<div class="box-footer">
               	<a class="btn btn-info" href="stulist.htm">
