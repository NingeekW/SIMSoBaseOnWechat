						...
						<div class="col-xs-12">
							<div class="box box-info">
								...
								<div class="box-footer">
									<button type="submit"
										onclick="javascript:window.location.href='addcourse.htm'"
										class="btn  btn-info">添加课程信息</button>
									<button type="submit"
												...
												<table id="example2"
													...
													<thead>
														<tr role="row">
															<th class="sorting_asc" tabindex="0"
																...
																aria-sort="ascending"
																aria-label="Rendering engine: activate to sort column descending">课程号</th>
															<th class="sorting" tabindex="0" aria-controls="example2"
																rowspan="1" colspan="1"
																aria-label="Browser: activate to sort column ascending">课程名称</th>
													...
													<tbody>
														...
														<c:forEach items="${CourseInfos}" var="CourseInfo">
															...
															<tr role="row" class="odd" id="${CourseInfo.courseId}">
																<td class="sorting_1">${CourseInfo.courseId}</td>
																...
																<td>${CourseInfo.credit}</td>
																	...
																	<div >
																		<button type="submit"
																			onclick="javascript:window.location.href='courseinfo.htm?id=${CourseInfo.courseId}'"
																			class="btn  btn-info">详情</button>
																		<button type="submit"
																			onclick="javascript:window.location.href='coursedelete.htm?id=${CourseInfo.courseId}'"
