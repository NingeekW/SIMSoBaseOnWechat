						...
						<div class="col-xs-12">
							<div class="box box-info">
								...
								<div class="box-footer">
									<button type="submit"
										onclick="javascript:window.location.href='addspec.htm'"
										class="btn  btn-info">添加专业信息</button>
									<button type="submit"
										onclick="javascript:window.location.href='speclist.htm'"
										class="btn  btn-info">刷新</button>
								</div>
								<!-- 搜索框 -->
								<form action="specByName.htm" method="post" id="SelectByName">
									<div class="input-group input-group-lg">
										<input type="text" name="specName" class="form-control"
											placeholder="请输入搜索专业名称..."> <span
											class="input-group-btn">
											<button type="submit" name="specName" id="search-btn"
												class="btn btn-flat">
												...
												<table id="example2"
													...
													<thead>
														<tr role="row">
															<th class="sorting_asc" tabindex="0"
																...
																aria-sort="ascending"
																aria-label="Rendering engine: activate to sort column descending">专业号</th>
															<th class="sorting" tabindex="0" aria-controls="example2"
																rowspan="1" colspan="1"
																aria-label="Browser: activate to sort column ascending">专业名称</th>
															<th class="sorting" tabindex="0" aria-controls="example2"
																rowspan="1" colspan="1"
													...
													<tbody>
														<c:forEach items="${Specialtys}" var="Specialty">
															<tr role="row" class="odd" id="${Specialty.specId}">
																<td class="sorting_1">${Specialty.specId}</td>
																<td>${Specialty.specName}</td>
																<td>
																	<div >
																		<button type="submit"
																			onclick="javascript:window.location.href='specinfo.htm?id=${Specialty.specId}'"
																			class="btn  btn-info">详情</button>
																		<button type="submit"
																			onclick="javascript:window.location.href='specdelete.htm?id=${Specialty.specId}'"
													...
													<tfoot>
														<tr>
															<th rowspan="1" colspan="1">专业号</th>
															<th rowspan="1" colspan="1">专业名称</th>
