					...
					<div class="col-md-30">
						...
						<!-- general form elements disabled -->
							...
							<div class="box-header with-border">
								...
								<a class="icon fa fa-ban" href="addcourse.htm"> 添加课程信息</a>
							</div>
																<!-- 搜索框 -->
							<form action="CourseByName.htm" method="post" id="SelectByName"
								...
								<div class="input-group">
									<input type="text" name="courseName" class="form-control"
										placeholder="请输入搜索课程名称..."> <span class="input-group-btn">
																...
																<td>
																	<div class="button-group">
																		<a class="button border-main"
																			href="stuinfo.htm?id=${StuInfo.stuId}"><span
																			class="icon-edit"></span> 详情</a> <a
																			class="button border-red"
																			href="studelete.htm?id=${StuInfo.stuId}"
