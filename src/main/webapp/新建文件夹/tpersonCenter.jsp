            ...
            <div class="box-body">
              <form role="form">
                ...
                <div class="form-group">
                  <label>教工号</label>
                  <input type="text" class="form-control"  readonly placeholder="${TAInfo.taId}" value="${TAInfo.taId}"name="taId">
                </div>
                <div class="form-group">
                  <label>姓名</label>
                ...
                <div class="form-group">
                  <label>性别</label>
                  <select class="form-control"  placeholder="${TAInfo.taSex}" value="${TAInfo.taSex}">
                ...
                <div class="form-group">
                  <label>生日</label>
                  <input type="text" class="form-control"  required placeholder="${TAInfo.taBirth}" value="${TAInfo.taBirth}"name="taBirth">
                </div>
                <div class="form-group">
                  <label>民族</label>
                ...
                <div class="form-group">
                  <label>入职时间</label>
                  <input type="text" class="form-control" required placeholder="${TAInfo.taEntranceDate}" value="${TAInfo.taEntranceDate}"name="taEntranceDate">
                </div>
                <div class="form-group">
                  <label>家庭住址</label>
                ...
                <div class="form-group">
                  <label>政治面貌</label>
                  <input type="text" class="form-control" required placeholder="${TAInfo.taPolitic}" value="${TAInfo.taPolitic}"name="taPolitic">
                </div>
                ...
                <div class="form-group">
                  <label>专业</label>
                  <input type="text" class="form-control" required placeholder="${TAInfo.taSpecialty}" value="${TAInfo.taSpecialty}"name="taSpecialty">
                </div>
                <div class="form-group">
                  <label>密码</label>
                  <input type="password" class="form-control" required id="exampleInputPassword1" placeholder="Password" name="passwd">
                </div>
