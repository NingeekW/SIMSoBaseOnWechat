            ...
            <div class="box-body">
              <form role="form" method="post" class="form-x" action="infoupdata.htm">
                ...
                <div class="form-group">
                  <label>教工号</label>
                  <input type="text" class="form-control"  required placeholder="${TAInfo.taId}" value="${TAInfo.taId}"name=taId">
                </div>
                <div class="form-group">
                  <label>姓名</label>
                ...
                <div class="form-group">
                  <label>政治面貌</label>
                  <select class="form-control"  placeholder="${TAInfo.taPolitic}" value="${TAInfo.taPolitic}">
                ...
                <div class="form-group">
                  <label>专业</label>
                  <select class="form-control"  placeholder="${TAInfo.taSpecialty}" value="${TAInfo.taSpecialty}" name="taSpecialty">
