						...
						<div class="col-xs-12">
							<div class="box box-info">
								...
								<div class="callout callout-info">
									<a class="icon fa fa-ban" href="allscore.htm"> 刷新</a>
								</div>
								<!-- 搜索框 -->
																...
																<td>
																	<div class="button-group">
																		<a class="button border-main"
																			href="goscoreupdate.htm?courseId=${StuCourse.courseId}&stuId=${StuCourse.stuId}&courseName=${StuCourse.courseName}"><span
																			class="icon-edit"></span> 成绩修改</a> <a
																			class="button border-red"
																			href="scoredelete.htm?courseId=${StuCourse.courseId}&stuId=${StuCourse.stuId}"
																			onclick="javascript:return del()"><span
																			class="icon-trash-o"></span> 删除成绩</a>
																	</div>
																</td>
															</tr>
														</c:forEach>
