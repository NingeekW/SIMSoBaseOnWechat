					...
					<div class="col-md-30">
						...
						<div class="box box-info">
							<div class="box-header with-border">
								<h3 class="box-title">分数管理</h3>
							</div>
							<!-- /.box-header -->
							<div class="box-body">
								<form role="form" method="post" action="scoreadd.htm">
									<div class="form-group">
										<label>学号</label> 
										<input  type="text" value="${id}" disabled name="stuId" class="form-control">
									</div>
									<div class="form-group">
										<label>课程名称</label> <select class="form-control" name="courseId">
									...
									<div class="form-group">
										<label>分数</label> <input type="text" name="stuGrade"
											class="form-control" required placeholder="分数">
									</div>
									<div class="box-footer">
										<button type="submit"
											onclick="javascript:window.location.href='couscorelist.htm?id=${id}'"
