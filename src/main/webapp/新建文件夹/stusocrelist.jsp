					...
					<div class="col-md-30">
						...
						<!-- general form elements disabled -->
							...
							<div class="box-header with-border">
								<h3 class="box-title">学生成绩管理</h3>
							</div>
									<div class="callout callout-info">
								<a class="icon fa fa-ban" href="stuscorelist.htm"> 刷新</a>
							</div>
																<!-- 搜索框 -->
												...
												<div class="col-sm-12">
													...
													<tbody>
														<c:forEach items="${StuInfos}" var="StuInfo">
															<tr role="row" class="odd" id="${StuInfo.stuId}">
																...
																<td>
																	<div class="button-group">
																		<a class="button border-main"
																			href="couscorelist.htm?id=${StuInfo.stuId}"><span
																			class="icon-edit"></span> 成绩管理</a>
																	</div>
																</td>
															</tr>
														</c:forEach>
