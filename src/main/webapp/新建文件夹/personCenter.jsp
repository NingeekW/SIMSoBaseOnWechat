          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <form role="form">
                ...
                <div class="form-group">
                  <label>性别</label>
                  <select class="form-control"  placeholder="${StuInfo.stuSex}" value="${StuInfo.stuSex}">
                ...
                <div class="form-group">
                  <label>生日</label>
                  <input type="text" class="form-control"  required placeholder="${StuInfo.stuBirth}" value="${StuInfo.stuBirth}"name="stuBirth">
                </div>
                <div class="form-group">
                  <label>民族</label>
                ...
                <div class="form-group">
                  <label>入职时间</label>
                  <input type="text" class="form-control" required placeholder="${StuInfo.stuEntranceDate}" value="${StuInfo.stuEntranceDate}"name="stuEntranceDate">
                </div>
                <div class="form-group">
                  <label>家庭住址</label>
                ...
                <div class="form-group">
                  <label>政治面貌</label>
                  <input type="text" class="form-control" required placeholder="${StuInfo.stuPolitic}" value="${StuInfo.stuPolitic}"name="stuPolitic">
                </div>
